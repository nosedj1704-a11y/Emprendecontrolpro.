...
body{
background:linear-gradient(to bottom,#f7f4ff,#ebe1ff);
padding:15px;
color:#333;
}
...
header{
background:linear-gradient(135deg,#6a0dad,#9b59ff);
color:white;
padding:25px 20px;
border-radius:25px;
text-align:center;
...
outline:none;
border-color:#8e44ec;
box-shadow:0 0 8px rgba(142,68,236,0.2);
}
...
<img class="icono" src="https://cdn-icons-png.flaticon.com/512/2331/2331970.png">
...
<button class="editar" onclick="editarVenta(${index})">
Editar
</button>

<button class="eliminar" onclick="eliminarVenta(${index})">
Eliminar
</button>
